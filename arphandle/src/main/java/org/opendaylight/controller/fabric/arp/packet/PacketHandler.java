...
public class PacketHandler implements PacketProcessingListener {
    ...
    private final Logger _logger = LoggerFactory.getLogger(PacketHandler.class);
    ...
    public PacketHandler(DataBrokerService dataService,
    ...
    private void handlePacket(Packet packet, NodeConnectorRef ingress){
        ...
        if(dstNCR == null){
            ...
            if(this.checkSameNode(ingress,dstNCR)){
                ...
                this.flowWriterService.addMacToMacFlowsFabricPath(srcMacAddress, ingress, dstMacAddress, dstNCR,tag);
                tag = (dstTag << FabricTag.VLAN.getIntValue()) + srcTag;
                this.flowWriterService.addMacToMacFlowsFabricPath(dstMacAddress, dstNCR, srcMacAddress, ingress,tag);
            }
    ...
    */
    ...
    private long getTag(NodeConnectorRef nrc){
        InstanceIdentifierUtils.getNodeConnectorKey(nrc.getValue()).getId();
