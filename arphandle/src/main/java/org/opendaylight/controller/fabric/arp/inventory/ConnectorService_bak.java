...
public class ConnectorService_bak {
     ...
     * @param dataService
     */
    public ConnectorService_bak(DataBrokerService dataService){
    ...
    public void update(){
        ...
        Topology topology =(Topology)this.dataService.readOperationalData(topologyPath);
        if(topology != null){
