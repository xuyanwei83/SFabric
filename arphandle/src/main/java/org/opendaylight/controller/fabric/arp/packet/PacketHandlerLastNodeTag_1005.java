 ...
 * target or not.
 */
public class PacketHandlerLastNodeTag_1005 implements PacketProcessingListener {

    private final Logger _logger = LoggerFactory.getLogger(PacketHandlerLastNodeTag_1005.class);
    ...
    public PacketHandlerLastNodeTag_1005(DataBroker dataService,
