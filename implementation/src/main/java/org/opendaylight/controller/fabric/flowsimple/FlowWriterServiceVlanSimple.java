...
public class FlowWriterServiceVlanSimple implements FlowWriterServiceSimple{
     ...
     */
    public FlowWriterServiceVlanSimple(DataBrokerService dataBrokerService,
    ...
    private void AddFabricFlow(long tag, NodeConnectorRef destNodeConnectorRef) {
        ...
        InstanceIdentifier<Flow> flowPath = this.BuildFlowPath(destNodeConnectorRef, flowTableKey,tag);
     ...
     * @return
     */
    private InstanceIdentifier<Flow> BuildFlowPath(NodeConnectorRef nodeConnectorRef, TableKey flowTableKey,long tag) {
        // generate unique flow key
        //FlowId flowId = new FlowId(String.valueOf(flowIdInc.getAndIncrement()));
        FlowId flowId = new FlowId("vlan:"+String.valueOf(tag));
